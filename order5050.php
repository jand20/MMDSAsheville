...
$title1='Date ranges '.$dt_1.' to '.$dt_1;

$conn = mysql_connect('localhost', 'root', '!mdi634');
mysql_select_db('showp1',$conn);
...
$conn1 = mysql_connect('localhost', 'root', '!mdi634');
mysql_select_db('ordernew',$conn1);
...
$sql_values_fetch_ord = mysql_fetch_array(mysql_query("select * from tblorderdetails where fldacsno1 =  '$acsno' OR fldacsno2 =  '$acsno' OR
fldacsno3 =  '$acsno' OR fldacsno4 =  '$acsno' OR fldacsno5 =  '$acsno' OR fldacsno6 =  '$acsno'"));
...
$pname=$sql_values_fetch_ord['fldLastName']. ',' .$sql_values_fetch_ord['fldLastName'];
