...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="main.png">
    <tr>
      <td width="37%" colspan="5" class="lab"><div align="center">Enter the Details to Produce QA Monthly Detailed Report </div></td>
    </tr>
    <tr>
      <td colspan="5">&nbsp;</td>
    </tr>
...
$y=$_REQUEST['year'];
$m=$_REQUEST['month'];
//$redirecturl = "?pg=40&dt1=$y&dt2=$m&d=$fac";
$redirecturl = "mdet.php?dt1=$y&dt2=$m&d=$fac";
