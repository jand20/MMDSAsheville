jQuery.fn.tooltip= function(options) {
	this.each(function(){
		...
		jQuery(this).hover(function() {
			...
			var clickElementy = jQuery.fn.getAbsoluteTopObject(this) + 250; //set y position
			var title="&nbsp;";
			jQuery("body").append("<div id='NT'><div id='NT_copy'>"+jQuery(this).children("."+settings.tooltipcontentclass).html()+"</div></div>");//right side
			var arrowOffset =  this.offsetWidth + 11;
			//var clickElementx = jQuery.fn.getAbsoluteLeftObject(this) + arrowOffset;
			var clickElementx = jQuery.fn.getAbsoluteLeftObject(this) - 40;// + arrowOffset;
