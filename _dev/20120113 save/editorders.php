...
B</label>
            ...
            <td width="48%"><span class="lab">
              <input name="symptoms1" type="text" size="40"  value="<?=$sql_values_fetch['fldSymptom1']?>" />
            </span></td>
            <td width="2%">&nbsp;</td>
          </tr>
          <tr>
...
B</label>
      ...
      <tr>
        ...
        <option value="MA" <? if($sql_values_fetch['fldState'] == "MA") {?> selected="selected" <? } else {?> selected="selected" <? }?>>MA</option>
...
$pr1icd1=$sql_values_icd['fldProc1icd1'];
$pr1icd2=$sql_values_icd['fldProc1icd2'];
$pr1icd3=$sql_values_icd['fldProc1icd3'];
$pr1icd4=$sql_values_icd['fldProc1icd4'];
$pr1dig=$sql_values_icd['fldProc1dig'];
}
...
$pr2icd1=$sql_values_icd['fldProc2icd1'];
$pr2icd2=$sql_values_icd['fldProc2icd2'];
$pr2icd3=$sql_values_icd['fldProc2icd3'];
$pr2icd4=$sql_values_icd['fldProc2icd4'];
$pr2dig=$sql_values_icd['fldProc2dig'];
}
...
$pr3icd1=$sql_values_icd['fldProc3icd1'];
$pr3icd2=$sql_values_icd['fldProc3icd2'];
$pr3icd3=$sql_values_icd['fldProc3icd3'];
$pr3icd4=$sql_values_icd['fldProc3icd4'];
$pr3dig=$sql_values_icd['fldProc3dig'];
}
...
$pr4icd1=$sql_values_icd['fldProc4icd1'];
$pr4icd2=$sql_values_icd['fldProc4icd2'];
$pr4icd3=$sql_values_icd['fldProc4icd3'];
$pr4icd4=$sql_values_icd['fldProc4icd4'];
$pr4dig=$sql_values_icd['fldProc4dig'];
}
...
$pr5icd1=$sql_values_icd['fldProc5icd1'];
$pr5icd2=$sql_values_icd['fldProc5icd2'];
$pr5icd3=$sql_values_icd['fldProc5icd3'];
$pr5icd4=$sql_values_icd['fldProc5icd4'];
$pr5dig=$sql_values_icd['fldProc5dig'];
}
...
$pr6icd1=$sql_values_icd['fldProc6icd1'];
$pr6icd2=$sql_values_icd['fldProc6icd2'];
$pr6icd3=$sql_values_icd['fldProc6icd3'];
$pr6icd4=$sql_values_icd['fldProc6icd4'];
$pr6dig=$sql_values_icd['fldProc6dig'];
}
...
$pdf->Cell(110,10,'Pacific Mobile Diagnostics   ',0,0,'C');
$pdf->Ln();
