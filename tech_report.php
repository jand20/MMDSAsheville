...
$user=$_SESSION['user'];
$sql="select distinct fldFacilityName from tblorderdetails where fldSchDate >= '$st_date' AND fldSchDate <= '$end_date' AND  fldTechnologist='$user'";
?>
...
?>
  ...
  <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" background="main.png">
    <tr>
      <td colspan="9"><div align="center">Name of Facility : <?=$facy?></div></td>
    </tr>
	<tr>
	  <td width="4%">&nbsp;</td>
	  <td width="15%"><div align="center">Patient Name</div></td>
	  <td width="6%"><div align="center">Patient ID</div></td>
	  <td width="10%"><div align="center">DOB</div></td>
	  <td width="6%"><div align="center">Room#</div></td>
	  <td width="6%"><div align="center">Symptoms</div></td>
	  <td width="8%"><div align="center">L/R/B</div></td>
	  <td width="10%"><div align="center">Procedure Description</div></td>
	  <td width="10%"><div align="center">Date Needed</div></td>
	</tr>
<?
$sno=0;
$sql_1="select * from tblorderdetails where fldFacilityName = '$facy' AND fldSchDate >= '$st_date' AND fldSchDate <= '$end_date' AND fldTechnologist like '$user' ";
